...
% Task-2: simualtion for 10 iteration with 100 individuals
...
% number of individuals to be 100.
...
%          set(gcf, 'units','normalized','outerposition',[0 0 1 1]);
   ...
   % saving the data after each iterations into ".mat" files.
    save(['Pandemic_100_' num2str(h) '.mat'],'health_per_time1','health_per_time2')
