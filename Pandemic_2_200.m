...
% Task-2: simualtion for 10 iteration with 200 individuals
...
% number of individuals to be 200.
...
no_of_per= 200;      % total number of individuals taken for simulation
...
vert_limit_end=2;       % vertical limit end
...
y_position= 2*rand(no_of_per,1);    % using rand built-in function for generating random y coordinates for individuals
position= [x_position y_position];  % combining x and y coordinates and building a position vector for 200 individuals


% Creating velocity vector for 200 individuals:
...
for h=1:iterations
    ...
    for i=1:length(time)            
        ...
        % Calculating new position after ecah time step for 200 points 
...
%          set(gcf, 'units','normalized','outerposition',[0 0 1 1]);
   ...
   % saving the data after each iterations into ".mat" files.
    save(['Pandemic_200_' num2str(h) '.mat'],'health_per_time1','health_per_time2')
